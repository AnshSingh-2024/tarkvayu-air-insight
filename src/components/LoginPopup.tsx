        ...
        <DialogHeader>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            {isSignUp 
              ...
              : "Sign in to your TarkVayu account"
            }
          </p>
        </DialogHeader>
          ...
          <div>
            ...
            <div className="mt-1 relative">
              ...
              <Input
                ...
                className="pl-10 bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:text-white"
                required
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-1 relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 focus:border-blue-500 dark:text-white"
                required
              />
              <button
                type="button"
